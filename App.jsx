...
function MeetReedScreen({ onComplete }) {
  ...
  const screens = [
    {
      title:"Meet Reed.",
      body:"Reed is your AI companion on Chins. Reed gets to know you, finds people you'd genuinely click with, and suggests potential connections on your behalf.\n\nEverything you share with Reed stays between you and Reed. Always.",
      reedMood:"excited",
    },
    {
